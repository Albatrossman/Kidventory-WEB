...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new codeux.design.filepicker.file_picker_writable.FilePickerWritablePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin file_picker_writable, codeux.design.filepicker.file_picker_writable.FilePickerWritablePlugin", e);
    }
    try {
